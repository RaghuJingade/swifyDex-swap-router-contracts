...
} from 'swifydex-v3-core/artifacts/contracts/SwifyDexFactory.sol/SwifyDexFactory.json'
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from 'swifydex-v2-core/build/UniswapV2Factory.json'
...
} from 'swifydex-v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
